    ...
    <div class="page-content">
      ...
      <div class="page-header flex justify-between items-start">
        <div>
          ...
          <h1 class="page-header__title">Gestion des Établissements Scolaires</h1>
          <p class="page-header__subtitle">supervision et administration des 1 247 centres d'enseignement partenaires Alternia</p>
        </div>
      ...
      <div class="kpi-grid mb-6">
        <div class="card flex flex-col justify-between">
          ...
          <div class="text-xs text-secondary mt-1">Représentant 14 pays</div>
        </div>

        <div class="card flex flex-col justify-between">
          <div class="flex justify-between items-center text-subtle text-xs">
            <span>MOYENNE BOÎTIERS / ÉTABLISSEMENT</span>
            <span class="badge badge--brand">10.3</span>
          </div>
          <div class="metric-value text-cyan mt-2">10,3</div>
          <div class="text-xs text-secondary mt-1">Ratio de pénétration des salles</div>
        </div>
        ...
        <div class="card flex flex-col justify-between">
          ...
          <div class="text-xs text-secondary mt-1">Abonnements sur 36 mois</div>
        </div>
          ...
          <tbody>
            @for (e of filteredEtablissements(); track e.id) {
              <tr>
                ...
                <td>
                  <span class="tag" [class.text-brand]="e.offre === 'Enterprise'" [class.text-cyan]="e.offre === 'Institutionnel'">
                    {{ e.offre }}
                  </span>
                </td>
                <td>
                  <div class="font-semibold text-mono text-brand">{{ e.boitiersCount }} boîtiers</div>
                </td>
                <td>
                  <div class="font-semibold text-mono">{{ e.licencesCount }} licences</div>
                </td>
                ...
                <td style="text-align: right;">
                  <div class="flex justify-end gap-1">
                    @if (e.statut === 'Actif') {
                      <button class="btn btn--ghost btn--sm text-accent" (click)="toggleStatut(e)">Suspendre</button>
                    } @else {
                      <button class="btn btn--ghost btn--sm text-success" (click)="toggleStatut(e)">Activer</button>
                    }
          ...
          <div class="card" style="width: 100%; max-width: 520px; background: white; border-radius: var(--r-xl); box-shadow: var(--s-xl);">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p class="text-xs text-secondary">Renseignez les données administratives pour créer un contrat</p>
              </div>
            ...
            <div class="flex flex-col gap-3">
              ...
              <div class="grid-3" style="grid-template-columns: 1fr 1fr; gap: 8px;">
                <div>
      ...
      @if (selectedEtab(); as e) {
        <div style="position: fixed; inset: 0; background: rgba(15, 23, 42, 0.5); backdrop-filter: blur(4px); z-index: 999; display: flex; align-items: center; justify-content: center; padding: 1rem;">
          <div class="card" style="width: 100%; max-width: 540px; background: white; border-radius: var(--r-xl); box-shadow: var(--s-xl);">
            <div class="flex justify-between items-start mb-4">
              <div>
                <span class="badge badge--brand mb-1">Fiche Établissement</span>
            ...
            <div class="grid-3 mb-4" style="grid-template-columns: 1fr 1fr; background: var(--c-surface); padding: 1rem; border-radius: var(--r-lg);">
              <div>
                ...
                <div class="font-semibold text-sm mt-1 text-success">{{ e.statut }}</div>
              </div>
              <div>
              ...
              <div class="mt-2">
                ...
                <div class="font-mono text-sm font-semibold mt-1">{{ e.boitiersCount }} unités</div>
              </div>
              <div class="mt-2">
                <div class="text-xs text-subtle">Licences Élèves/Familles</div>
                <div class="font-mono text-sm font-semibold mt-1">{{ e.licencesCount }} comptes</div>
              </div>
            </div>
