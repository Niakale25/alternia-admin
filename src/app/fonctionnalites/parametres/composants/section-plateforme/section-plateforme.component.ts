...
@Component({
  selector: 'app-section-plateforme',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './section-plateforme.component.html',
  styleUrls: ['./section-plateforme.component.scss']
})
export class SectionPlateformeComponent {
